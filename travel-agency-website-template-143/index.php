...
<html lang="en">
  ...
  <head>
    ...
    <title>Camp&Co | Outdoor Equipment Store</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="main-banner header-text" id="top">
        <div class="Modern-Slider">
          ...
          <div class="item item-2">
            <div class="img-fill">
                <div class="text-content">
                 <h6>Explorez la nature sans limites</h6>
                 <h4>Équipement Camping <br> Haut de gamme</h4>
                  <p>
          ...
          <div class="item item-3">
            <div class="img-fill">
                <div class="text-content">
                  <h6>Besoin d’aide pour votre équipement ?</h6>
                  <h4>Tente de camping <br>ultra résistante 4 saisons</h4>
                 <p>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="left-image">
                <img src="assets/imagesindex/image3.jpg" class="img-fluid" alt="">
              </div>
            </div>
