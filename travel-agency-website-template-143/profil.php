...
<head>
    ...
    <title>Camp&Co · Mon profilxxxxxxxxxxxxxx</title>
    ...
    <div class="container">
        <div class="profile-card login-card">
            <div class="login-card__header">
                ...
                <h1>Mon profilwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww</h1>
            ...
            <div class="profile-info">
                <div class="info-row">
                    <span class="info-label">Nom :xxxxx</span>
...
<form method="post" action="">
    ...
    <div class="info-row">
        ...
        <input type="text" name="nom" value="<?= htmlspecialchars($user["nom"]) ?>" class="info-value">
    </div>

    <div class="info-row">
        <span class="info-label">Prénom :</span>
        <input type="text" name="prenom" value="<?= htmlspecialchars($user["prenom"]) ?>" class="info-value">
    </div>
    ...
    <div class="info-row">
        <span class="info-label">Téléphone :</span>
        <input type="text" name="telephone" value="<?= htmlspecialchars($user["telephone"]) ?>" class="info-value">
    </div>
